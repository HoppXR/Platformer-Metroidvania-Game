...
namespace Platformer
{
    public class Swinging : MonoBehaviour
    {
        ...
        {
            // right
            if (Input.GetKey(KeyCode.D)) _rb.AddForce(orientation.right * (horizontalThrustForce * Time.deltaTime));
            // left
            if (Input.GetKey(KeyCode.A)) _rb.AddForce(-orientation.right * (horizontalThrustForce * Time.deltaTime));
            // forward
            if (Input.GetKey(KeyCode.W)) _rb.AddForce(orientation.forward * (forwardThrustForce * Time.deltaTime));
            // shorten cable
